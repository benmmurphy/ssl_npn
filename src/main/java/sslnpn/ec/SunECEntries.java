...
final class SunECEntries {
    ...
    static void putEntries(Map<Object, Object> map,
         ...
         *  Key Factory engine
         */
        map.put("KeyFactory.EC", "sslnpn.ec.ECKeyFactory");
         ...
         */
        map.put("AlgorithmParameters.EC", "sslnpn.ec.ECParameters");
        ...
        map.put("Signature.NONEwithECDSA",
            "sslnpn.ec.ECDSASignature$Raw");
        map.put("Signature.SHA1withECDSA",
            "sslnpn.ec.ECDSASignature$SHA1");
        map.put("Signature.SHA256withECDSA",
            "sslnpn.ec.ECDSASignature$SHA256");
        map.put("Signature.SHA384withECDSA",
            "sslnpn.ec.ECDSASignature$SHA384");
        map.put("Signature.SHA512withECDSA",
            "sslnpn.ec.ECDSASignature$SHA512");
         ...
         */
        map.put("KeyPairGenerator.EC", "sslnpn.ec.ECKeyPairGenerator");
         ...
         */
        map.put("KeyAgreement.ECDH", "sslnpn.ec.ECDHKeyAgreement");
