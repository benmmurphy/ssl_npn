...
import static sslnpn.ssl.CipherSuite.*;
                ...
                if (protocolVersion.v >= ProtocolVersion.TLS11.v) {
                    ...
                    if (bb.hasArray()) {
                        ...
                        System.arraycopy(buf, arrayOffset + pos,
                                buf, arrayOffset + pos + prefix.length, limit - pos);
            ...
            if (blockSize != 0) {
                ...
                if (protocolVersion.v >= ProtocolVersion.TLS11.v) {
                    ...
                    if (bb.hasArray()) {
                        int arrayOffset = bb.arrayOffset();
                        buf = bb.array();
                        System.arraycopy(buf, pos + arrayOffset + blockSize,
                                         buf, pos + arrayOffset, limit - pos - blockSize);
