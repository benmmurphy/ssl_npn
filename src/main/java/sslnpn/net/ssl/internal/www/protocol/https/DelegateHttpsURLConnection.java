...
package sslnpn.net.ssl.internal.www.protocol.https;
import java.net.URL;
...
public class DelegateHttpsURLConnection extends AbstractDelegateHttpsURLConnection {
    ...
    public sslnpn.net.ssl.HttpsURLConnection httpsURLConnection;

    DelegateHttpsURLConnection(URL url,
            sun.net.www.protocol.http.Handler handler,
            sslnpn.net.ssl.HttpsURLConnection httpsURLConnection)
            throws IOException {
...
class VerifierWrapper implements javax.net.ssl.HostnameVerifier {
    ...
    private sslnpn.net.ssl.HostnameVerifier verifier;

    VerifierWrapper(sslnpn.net.ssl.HostnameVerifier verifier) {
